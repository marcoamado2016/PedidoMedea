...
export async function POST(request: NextRequest) {
    ...
    let { numeroPedido, detalle, fechaPedido, estado, nombre, lomito, empanada, pizza, cono, hamburguesa, pancho, detalleempanada, detallepizza, detallelomo, detallecono, detallehamburguesa, detallepancho, precioempanada, preciopizza, preciolomito, preciocono, preciohamburguesa, preciopancho } = body;
    
    console.log("precioempanada, preciopizza, preciolomito, preciocono, preciohamburguesa, preciopancho ",precioempanada, preciopizza, preciolomito, preciocono, preciohamburguesa, preciopancho)
    ...
    const newPedido: IPedidoSchema = new Pedido({
        ...
        preciopizza, preciolomito, preciocono, preciohamburguesa, preciopancho
    })
    try {
