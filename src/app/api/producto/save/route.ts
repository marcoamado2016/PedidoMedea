...
export async function POST(request: NextRequest) {
    ...
    console.log("Body precio ", body)
    let { pizza, empanada, pizzam, empanadam, empanadau, cono, lomito, hamburguesa, fechaProducto } = body;
    pizza = pizza ? +pizza : 0;
    ...
    const newProducto: IProductoSchema = new Producto({
        pizza, empanada, empanadam, pizzam, empanadau, cono, lomito, hamburguesa, fechaProducto
    })
    try {
